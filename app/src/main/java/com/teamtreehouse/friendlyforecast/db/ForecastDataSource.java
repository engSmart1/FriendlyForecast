...
public class ForecastDataSource {
    ...
    public Cursor selectAllTemperatures(){
        Cursor cursor = mDatabase.query(
                ForecastHelper.TABLE_TEMPERATURES , new String[]{ForecastHelper.COLUMN_TEMPERATURE},
                null, //where columns
                null, //where params
                null ,//groupby
                null,// having
    ...
    public int updateTemperature(double newTemp){
        ...
        int rowsUpdate = mDatabase.update(
                ForecastHelper.TABLE_TEMPERATURES ,values,null ,null
        );
        return rowsUpdate;
    }
    ...
    public void deleteAll(){
        mDatabase.delete(ForecastHelper.TABLE_TEMPERATURES ,null // where clause
                ,null // where params
                 );
    }
