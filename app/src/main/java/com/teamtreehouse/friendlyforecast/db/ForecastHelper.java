...
public class ForecastHelper extends SQLiteOpenHelper {
  /* public static final String TABLE_TEMPERATURE = "TEMPERATURES";
    ...
    public static final String DB_CREATE = " CREATE TABLE"+ TABLE_TEMPERATURE + "(" +
    COLUMN_ID  + " INTEGER PRIMARY KEY AUTOINCREMENT ,"+ COLUMN_TEMPERATURE + " REAL)";
